...
{
    public function loadNewArtistFormPage(BrowseTester $I)
    {
    ...
    public function loadExistingArtistFormPage(BrowseTester $I)
    {
    ...
    public function loadArtistFormWithUnknownArtistId(BrowseTester $I)
    {
     ...
     */
    public function loadArtistFormWithWrongParameter(BrowseTester $I, Example $example)
    {
     ...
     */
    public function insertArtist(BrowseTester $I)
    {
     ...
     * @depends loadNewArtistFormPage
     */
    public function insertArtistWithMissingName(BrowseTester $I)
    {
        $I->amOnPage('/admin/artist-form.php');
     ...
     */
    public function updateArtist(BrowseTester $I)
    {
        $I->stopFollowingRedirects();
        $I->amOnPage('/admin/artist-form.php?artistId=4');
     ...
     * @depends loadExistingArtistFormPage
     */
    public function updateArtistWithMissingName(BrowseTester $I)
    {
        $I->amOnPage('/admin/artist-form.php?artistId=4');
        $I->submitForm('form', ['name' => '']);
        $I->seeInCurrentUrl('/admin/artist-save.php');
    ...
    public function deleteArtistWithoutId(BrowseTester $I)
    {
    ...
    public function deleteArtistWithWrongId(BrowseTester $I, Example $example)
    {
