<?php  //[STAMP] 1203b37a4fcf2bf531f40b8462dfd3ec
...
trait BrowseTesterActions
{
     ...
     *
     *
     * @see \Tests\Helper\Browse::seeResponseContentIs()
     */
    public function seeResponseContentIs(string $expected, string $message = "Response content does not match") {
        return $this->getScenario()->runStep(new \Codeception\Step\Assertion('seeResponseContentIs', func_get_args()));
    }
    /**
     * [!] Method is generated. Documentation taken from corresponding module.
     *
     ...
     * @see \Tests\Helper\Browse::seeResponseContentIs()
     */
    public function canSeeResponseContentIs(string $expected, string $message = "Response content does not match") {
        return $this->getScenario()->runStep(new \Codeception\Step\ConditionalAssertion('seeResponseContentIs', func_get_args()));
    }
