<?php  //[STAMP] 3f4100ee47875c9c137900056d42a62f
...
trait FormTesterActions
{
     ...
     *
     *
     * @see \Tests\Helper\Dom::amTestingPartialHtmlContent()
     */
    public function amTestingPartialHtmlContent(string $partialHtmlContent): void {
        $this->getScenario()->runStep(new \Codeception\Step\Condition('amTestingPartialHtmlContent', func_get_args()));
    }
     ...
     * @see \Tests\Helper\Dom::seeElementContainingText()
     */
    public function seeElementContainingText(string $element, string $text) {
        return $this->getScenario()->runStep(new \Codeception\Step\Assertion('seeElementContainingText', func_get_args()));
    }
    /**
     * [!] Method is generated. Documentation taken from corresponding module.
     *
     ...
     * @see \Tests\Helper\Dom::seeElementContainingText()
     */
    public function canSeeElementContainingText(string $element, string $text) {
        return $this->getScenario()->runStep(new \Codeception\Step\ConditionalAssertion('seeElementContainingText', func_get_args()));
    }
     ...
     * @see \Tests\Helper\Dom::seeElement()
     */
     ...
     * @see \Tests\Helper\Dom::seeElement()
     */
    public function canSeeElement(string $element) {
     ...
     *
     * @see https://codeception.com/docs/reference/Locator#firstElement
     * @see \Tests\Helper\Dom::dontSeeElement()
     */
     ...
     * @see \Tests\Helper\Dom::dontSeeElement()
     */
    public function cantSeeElement(string $element) {
